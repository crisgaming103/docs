...
ALLOWED_KEYS = ["NEL CPM TOOL"]
CHANNEL_ID = "-1004448258511"
CHANNEL_LINK = "https://t.me/+GfMJGbFux2A3ZmI1"
...
def subscription_required(message):
    ...
    bot.send_message(
        ...
        "Join our channel, then click **CHECK SUBSCRIPTION**.",
        reply_markup=markup,
        parse_mode="Markdown"
    )
...
def get_password(message):
    ...
    if version == "1":
        ...
        if result and result.get("ok"):
            ...
            #Saved Accounts temporarily disabled because save_account is not defined
...
def handle_all_messages(message):
    ...
    f"📧 Email: `{email}`\n\n"
    f"Choose an unlock method:",
    chat_id,
    loading_msg.message_id,
    reply_markup=create_unlock_cars_keyboard(chat_id),
    parse_mode='Markdown'
)
